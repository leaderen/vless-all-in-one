...
### ✨ 新功能
- Reality/XHTTP 协议支持真实域名配置，可偷自己域名流量
- 分流规则改用 geosite 规则库，覆盖更全面
- 自定义规则优先级提升，优先于预设规则匹配
- 自定义规则支持 IP 地址和 CIDR 格式
- 所有分流规则支持选择 IPv4/IPv6 出站
- SS 链接解析支持 SIP002 格式和查询参数
- 新增直连出口 IP 版本设置（仅 IPv4/仅 IPv6/优先 IPv4/优先 IPv6）
- BBR 优化增强：智能检测系统配置，6档内存自适应参数，支持查看/重新优化/卸载

### 🐛 修复
- 修复 NaïveProxy 在 Debian 系统安装失败的问题
---
