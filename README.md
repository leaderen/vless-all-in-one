...
### ✨ 新功能
- **导入订阅延迟预览** - 导入前自动检测所有节点延迟，按延迟排序展示，方便筛选优质节点

### 🐛 修复
- 修复 IPv6 节点地址解析问题 (SS/VLESS/Trojan/Hysteria2 协议)
- 修复 IPv6 节点延迟检测超时，改用 ICMP ping 方式检测
- 修复 wgcf无法下载问题
...
─────────────────────────────────────────────
  ...
  节点列表 (按延迟排序):
─────────────────────────────────────────────
  [8ms] 🇯🇵日本高速06 (BGP) (vless) 104.18.43.89
  [9ms] 🇭🇰香港高速03 (BGP) (vless) 43.199.67.131
  [10ms] 🇭🇰香港高速04 (BGP) (vless) 18.162.246.126
  [38ms] 🇸🇬新加坡高速01 (BGP) (vless) 13.213.48.122
  [56ms] 🇯🇵日本高速01 (BGP) (vless) 54.150.216.155
  [147ms] 🇺🇸美国高速01 (vless) 44.249.20.105
  [223ms] v6节点 (shadowsocks) 2a0f:7803::1
  [超时] 🇰�韩国高速01 (BGP) o(vless) -
─────────────────────────────────────────────
  确认导入这 22 个节点? [Y/n]:
```
...
─────────────────────────────────────────────
  ...
  TCP延迟排序 (从低到高):
─────────────────────────────────────────────
  [9ms] 套餐到期：2028-08-27 (vless) 43.199.74.81
  [10ms] 剩余流量：95.74 GB (vless) 43.199.74.81
  [223ms] v6 (shadowsocks) 2a0f:7803:fb32:aa45::1
  [超时] 🇨🇳台湾高速01 (BGP) (vless) -
─────────────────────────────────────────────
```
